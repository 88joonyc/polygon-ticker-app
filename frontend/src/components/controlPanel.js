    ...
    return (
        <>
            <div className='max-w-[400px]'>
                <div className='flex flex-col border mt-20 p-8'>
                    <div>{control + ' ' + ticker}</div>
                    <form className='flex flex-col'>
                        ...
                        <button className='p-4 border rounded-full  my-8 text-xl text-white font-bold bg-midnightPurple'>review order</button>
                    </form>
                </div>
            </div>
        </>
